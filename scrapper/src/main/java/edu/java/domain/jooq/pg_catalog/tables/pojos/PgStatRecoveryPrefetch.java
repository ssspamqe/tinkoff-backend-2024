...
public class PgStatRecoveryPrefetch implements Serializable {
    ...
    public PgStatRecoveryPrefetch(PgStatRecoveryPrefetch value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final PgStatRecoveryPrefetch other = (PgStatRecoveryPrefetch) obj;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("PgStatRecoveryPrefetch (");
