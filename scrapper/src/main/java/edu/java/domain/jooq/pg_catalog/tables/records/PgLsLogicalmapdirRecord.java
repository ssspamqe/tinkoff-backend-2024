...
public class PgLsLogicalmapdirRecord extends TableRecordImpl<PgLsLogicalmapdirRecord> implements Record3<String, Long, OffsetDateTime> {
    ...
    @Override
    @NotNull
    public PgLsLogicalmapdirRecord value1(@Nullable String value) {
        setName(value);
        return this;
    }
    ...
    @Override
    @NotNull
    public PgLsLogicalmapdirRecord value2(@Nullable Long value) {
        setSize(value);
        return this;
    }
    ...
    @Override
    @NotNull
    public PgLsLogicalmapdirRecord value3(@Nullable OffsetDateTime value) {
    ...
    @Override
    @NotNull
    public PgLsLogicalmapdirRecord values(@Nullable String value1, @Nullable Long value2, @Nullable OffsetDateTime value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
    ...
    public PgLsLogicalmapdirRecord(@Nullable String name, @Nullable Long size, @Nullable OffsetDateTime modification) {
        super(PgLsLogicalmapdir.PG_LS_LOGICALMAPDIR);
     ...
     * Create a detached, initialised PgLsLogicalmapdirRecord
     */
    public PgLsLogicalmapdirRecord(edu.java.domain.jooq.pg_catalog.tables.pojos.PgLsLogicalmapdir value) {
        super(PgLsLogicalmapdir.PG_LS_LOGICALMAPDIR);
