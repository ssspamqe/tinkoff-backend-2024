...
public class PgStatRecoveryPrefetchRecord extends TableRecordImpl<PgStatRecoveryPrefetchRecord> implements Record10<OffsetDateTime, Long, Long, Long, Long, Long, Long, Integer, Integer, Integer> {
    ...
    @Override
    @NotNull
    public PgStatRecoveryPrefetchRecord value1(@Nullable OffsetDateTime value) {
        setStatsReset(value);
        return this;
    }
    ...
    @Override
    @NotNull
    public PgStatRecoveryPrefetchRecord value2(@Nullable Long value) {
        setPrefetch(value);
        return this;
    }
    ...
    @Override
    @NotNull
    public PgStatRecoveryPrefetchRecord value3(@Nullable Long value) {
        setHit(value);
        return this;
    }
    ...
    @Override
    @NotNull
    public PgStatRecoveryPrefetchRecord value4(@Nullable Long value) {
        setSkipInit(value);
        return this;
    }
    ...
    @Override
    @NotNull
    public PgStatRecoveryPrefetchRecord value5(@Nullable Long value) {
        setSkipNew(value);
        return this;
    }
    ...
    @Override
    @NotNull
    public PgStatRecoveryPrefetchRecord value6(@Nullable Long value) {
        setSkipFpw(value);
        return this;
    }
    ...
    @Override
    @NotNull
    public PgStatRecoveryPrefetchRecord value7(@Nullable Long value) {
        setSkipRep(value);
        return this;
    }
    ...
    @Override
    @NotNull
    public PgStatRecoveryPrefetchRecord value8(@Nullable Integer value) {
    ...
    @Override
    @NotNull
    public PgStatRecoveryPrefetchRecord value9(@Nullable Integer value) {
    ...
    @Override
    @NotNull
    public PgStatRecoveryPrefetchRecord value10(@Nullable Integer value) {
        setIoDepth(value);
        return this;
    }
    ...
    @Override
    @NotNull
    public PgStatRecoveryPrefetchRecord values(@Nullable OffsetDateTime value1, @Nullable Long value2, @Nullable Long value3, @Nullable Long value4, @Nullable Long value5, @Nullable Long value6, @Nullable Long value7, @Nullable Integer value8, @Nullable Integer value9, @Nullable Integer value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
