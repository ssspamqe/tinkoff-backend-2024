...
public class PgLsTmpdir implements Serializable {
    ...
    public PgLsTmpdir(PgLsTmpdir value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final PgLsTmpdir other = (PgLsTmpdir) obj;
        if (this.name == null) {
            if (other.name != null)
                return false;
        }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("PgLsTmpdir (");
