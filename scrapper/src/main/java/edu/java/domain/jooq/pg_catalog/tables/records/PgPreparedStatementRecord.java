...
public class PgPreparedStatementRecord extends TableRecordImpl<PgPreparedStatementRecord> implements Record8<String, String, OffsetDateTime, Object[], Object[], Boolean, Long, Long> {
    ...
    @Override
    @NotNull
    public PgPreparedStatementRecord value1(@Nullable String value) {
        setName(value);
        return this;
    }
    ...
    @Override
    @NotNull
    public PgPreparedStatementRecord value2(@Nullable String value) {
        setStatement(value);
        return this;
    }
    ...
    @Override
    @NotNull
    public PgPreparedStatementRecord value3(@Nullable OffsetDateTime value) {
    ...
    @Override
    @NotNull
    public PgPreparedStatementRecord value4(@Nullable Object[] value) {
    ...
    @Override
    @NotNull
    public PgPreparedStatementRecord value5(@Nullable Object[] value) {
    ...
    @Override
    @NotNull
    public PgPreparedStatementRecord value6(@Nullable Boolean value) {
        setFromSql(value);
        return this;
    }
    ...
    @Override
    @NotNull
    public PgPreparedStatementRecord value7(@Nullable Long value) {
    ...
    @Override
    @NotNull
    public PgPreparedStatementRecord value8(@Nullable Long value) {
    ...
    @Override
    @NotNull
    public PgPreparedStatementRecord values(@Nullable String value1, @Nullable String value2, @Nullable OffsetDateTime value3, @Nullable Object[] value4, @Nullable Object[] value5, @Nullable Boolean value6, @Nullable Long value7, @Nullable Long value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
