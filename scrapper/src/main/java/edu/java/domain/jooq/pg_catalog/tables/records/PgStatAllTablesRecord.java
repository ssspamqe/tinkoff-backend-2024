...
public class PgStatAllTablesRecord extends TableRecordImpl<PgStatAllTablesRecord> {
     ...
     * Create a detached, initialised PgStatAllTablesRecord
     */
    public PgStatAllTablesRecord(edu.java.domain.jooq.pg_catalog.tables.pojos.PgStatAllTables value) {
        super(PgStatAllTables.PG_STAT_ALL_TABLES);
