...
public class PgLsWaldir implements Serializable {
    ...
    public PgLsWaldir(PgLsWaldir value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final PgLsWaldir other = (PgLsWaldir) obj;
        if (this.name == null) {
            if (other.name != null)
                return false;
        }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("PgLsWaldir (");
