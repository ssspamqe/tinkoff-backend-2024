...
public class PgFileSettingsRecord extends TableRecordImpl<PgFileSettingsRecord> implements Record7<String, Integer, Integer, String, String, Boolean, String> {
    ...
    @Override
    @NotNull
    public PgFileSettingsRecord value1(@Nullable String value) {
        setSourcefile(value);
        return this;
    }
    ...
    @Override
    @NotNull
    public PgFileSettingsRecord value2(@Nullable Integer value) {
        setSourceline(value);
        return this;
    }
    ...
    @Override
    @NotNull
    public PgFileSettingsRecord value3(@Nullable Integer value) {
        setSeqno(value);
        return this;
    }
    ...
    @Override
    @NotNull
    public PgFileSettingsRecord value4(@Nullable String value) {
        setName(value);
        return this;
    }
    ...
    @Override
    @NotNull
    public PgFileSettingsRecord value5(@Nullable String value) {
        setSetting(value);
        return this;
    }
    ...
    @Override
    @NotNull
    public PgFileSettingsRecord value6(@Nullable Boolean value) {
        setApplied(value);
        return this;
    }
    ...
    @Override
    @NotNull
    public PgFileSettingsRecord value7(@Nullable String value) {
        setError(value);
        return this;
    }
    ...
    @Override
    @NotNull
    public PgFileSettingsRecord values(@Nullable String value1, @Nullable Integer value2, @Nullable Integer value3, @Nullable String value4, @Nullable String value5, @Nullable Boolean value6, @Nullable String value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
