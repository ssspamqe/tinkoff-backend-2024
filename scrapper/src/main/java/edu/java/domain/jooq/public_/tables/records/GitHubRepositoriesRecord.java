...
public class GitHubRepositoriesRecord extends UpdatableRecordImpl<GitHubRepositoriesRecord>
    implements Record6<Long, Long, String, String, String, Long[]> {
    ...
    @Override
    @NotNull
    public GitHubRepositoriesRecord values(
        @NotNull Long value1,
        @NotNull Long value2,
