...
public class PgStatioAllIndexesRecord extends TableRecordImpl<PgStatioAllIndexesRecord> implements Record7<Long, Long, String, String, String, Long, Long> {
    ...
    @Override
    @NotNull
    public PgStatioAllIndexesRecord value1(@Nullable Long value) {
        setRelid(value);
        return this;
    }
    ...
    @Override
    @NotNull
    public PgStatioAllIndexesRecord value2(@Nullable Long value) {
        setIndexrelid(value);
        return this;
    }
    ...
    @Override
    @NotNull
    public PgStatioAllIndexesRecord value3(@Nullable String value) {
        setSchemaname(value);
        return this;
    }
    ...
    @Override
    @NotNull
    public PgStatioAllIndexesRecord value4(@Nullable String value) {
        setRelname(value);
        return this;
    }
    ...
    @Override
    @NotNull
    public PgStatioAllIndexesRecord value5(@Nullable String value) {
    ...
    @Override
    @NotNull
    public PgStatioAllIndexesRecord value6(@Nullable Long value) {
    ...
    @Override
    @NotNull
    public PgStatioAllIndexesRecord value7(@Nullable Long value) {
        setIdxBlksHit(value);
        return this;
    }
    ...
    @Override
    @NotNull
    public PgStatioAllIndexesRecord values(@Nullable Long value1, @Nullable Long value2, @Nullable String value3, @Nullable String value4, @Nullable String value5, @Nullable Long value6, @Nullable Long value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
