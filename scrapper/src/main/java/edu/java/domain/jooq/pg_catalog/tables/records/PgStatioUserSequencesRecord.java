...
public class PgStatioUserSequencesRecord extends TableRecordImpl<PgStatioUserSequencesRecord> implements Record5<Long, String, String, Long, Long> {
    ...
    @Override
    @NotNull
    public PgStatioUserSequencesRecord value1(@Nullable Long value) {
        setRelid(value);
        return this;
    }
    ...
    @Override
    @NotNull
    public PgStatioUserSequencesRecord value2(@Nullable String value) {
        setSchemaname(value);
        return this;
    }
    ...
    @Override
    @NotNull
    public PgStatioUserSequencesRecord value3(@Nullable String value) {
        setRelname(value);
        return this;
    }
    ...
    @Override
    @NotNull
    public PgStatioUserSequencesRecord value4(@Nullable Long value) {
        setBlksRead(value);
        return this;
    }
    ...
    @Override
    @NotNull
    public PgStatioUserSequencesRecord value5(@Nullable Long value) {
        setBlksHit(value);
        return this;
    }
    ...
    @Override
    @NotNull
    public PgStatioUserSequencesRecord values(@Nullable Long value1, @Nullable String value2, @Nullable String value3, @Nullable Long value4, @Nullable Long value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
