...
public class PgBackendMemoryContexts implements Serializable {
    ...
    public PgBackendMemoryContexts(PgBackendMemoryContexts value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final PgBackendMemoryContexts other = (PgBackendMemoryContexts) obj;
        if (this.name == null) {
            if (other.name != null)
                return false;
        }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("PgBackendMemoryContexts (");
