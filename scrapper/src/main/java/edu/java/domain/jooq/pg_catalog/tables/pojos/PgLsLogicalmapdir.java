...
public class PgLsLogicalmapdir implements Serializable {
    ...
    public PgLsLogicalmapdir(PgLsLogicalmapdir value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final PgLsLogicalmapdir other = (PgLsLogicalmapdir) obj;
        if (this.name == null) {
            if (other.name != null)
                return false;
        }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("PgLsLogicalmapdir (");
